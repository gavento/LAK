Intuivně, expandér je graf, jehož každá "rozumně velká" podmnožina má "dostatečně velkou" hranici. Tato vlastnost lze formalisovat několika způsoby: z pohledu hran, vrcholů a nebo vlastní čísel.

Žádný nesouvislý graf není dobrý expandér, zatímco úplný graf je typicky nejlepší expandér. Jeho problém tkví v jeho velikosti, jak si povíme později. Obecně se tedy snažíme najít rodinu grafů, která je dostatečně malá (typicky má malý stupeň), ale zato má poměrně dobrou expanzi.


\subsection{Expanzei formálně}
...
\begin{itemize}
	...
	\item $\lambda = \max\{\lambda_2,-\lambda_n\}$ (druhé největší vlastní číslo v absolutní hodnotě)
\end{itemize}

\vt (Cheegerovi nerovnosti) Mějme $G$ $d$-regulární graf, potom platí:  
$${1\over 2}(d-\lambda_2) \le h(G) \le \sqrt{2d(d-\lambda_2)}.$$

\dk (Jen první nerovnost, druhá je bez důkazu). Sporem: nechť $S$ je množina
vrcholů s malou hranovou expanzí.

Pro $x \bot (1,1,\dots,1)$ platí $\lambda_2 \ge {x^TAx\over x^Tx}$ (Rayleighův
